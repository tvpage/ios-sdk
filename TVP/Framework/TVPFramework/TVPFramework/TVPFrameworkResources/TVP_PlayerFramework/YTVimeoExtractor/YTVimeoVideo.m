...
-(NSURL *)highestQualityStreamURL{
    ...
    NSURL *url = self.streamURLs[@(YTVimeoVideoQualityHD2160)] ?: self.streamURLs[@(YTVimeoVideoQualityHD1440)] ?: self.streamURLs[@(YTVimeoVideoQualityHD1080)] ?: self.streamURLs[@(YTVimeoVideoQualityHD720)]?: self.streamURLs[@(YTVimeoVideoQualityMedium540)]?: self.streamURLs [@(YTVimeoVideoQualityMedium480)]?: self.streamURLs[@(YTVimeoVideoQualityMedium360)]?:self.streamURLs[@(YTVimeoVideoQualityLow270)];
...
-(NSURL *)lowestQualityStreamURL{
    ...
    NSURL *url = self.streamURLs[@(YTVimeoVideoQualityLow270)] ?: self.streamURLs[@(YTVimeoVideoQualityMedium360)] ?: self.streamURLs [@(YTVimeoVideoQualityMedium480)]?: self.streamURLs[@(YTVimeoVideoQualityMedium540)]?: self.streamURLs[@(YTVimeoVideoQualityHD720)]?:self.streamURLs[@(YTVimeoVideoQualityHD1080)] ?:  self.streamURLs[@(YTVimeoVideoQualityHD1440)] ? : self.streamURLs[@(YTVimeoVideoQualityHD2160)];
