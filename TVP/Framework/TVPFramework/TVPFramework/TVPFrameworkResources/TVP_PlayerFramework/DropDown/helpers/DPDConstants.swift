...
internal struct DPDConstant {
	...
	internal struct UI {
        ...
        static let SelectionTextColor = UIColor.white
		static let TextFont = UIFont.systemFont(ofSize: 15)
		static let BackgroundColor = UIColor(white: 0.94, alpha: 1)
		static let SelectionBackgroundColor = UIColor.init(red: 220.0/255.0, green: 127.0/255.0, blue: 49.0/255.0, alpha: 1.0)
