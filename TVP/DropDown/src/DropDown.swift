...
public final class DropDown: UIView {
	...
	*/
    ...
    public dynamic var selectionTextColor = DPDConstant.UI.SelectionTextColor
...
extension DropDown {
	...
	public override func updateConstraints() {
        ...
        let tableMaxHeight = CGFloat(160)
        
		xConstraint.constant = layout.x
		yConstraint.constant = (layout.y > (tableMaxHeight - 40) ? tableMaxHeight : layout.y)
		widthConstraint.constant = layout.width
        heightConstraint.constant = (layout.visibleHeight > tableMaxHeight ? tableMaxHeight : layout.visibleHeight)
		tableView.isScrollEnabled = (layout.visibleHeight > tableMaxHeight ? true : false)
...
extension DropDown {
	...
	*/
	public func reloadAllComponents() {
        ...
        tableView.setContentOffset(CGPoint.init(x: 0, y: CGFloat.greatestFiniteMagnitude), animated: false)
		setNeedsUpdateConstraints()
	}
